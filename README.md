...
- 选择公司已经在使用的 IT 工具，例如 `Jira`、`Confluence`、`Gerrit`、`SVN`、`Linux`、`腾讯企业邮箱`
...
- 基础技能扩展到 `Jira`、`Confluence`、`Gerrit`、`SVN`、`Linux`、`腾讯企业邮箱`。
...
- 当前内置基础工具包括 `Jira`、`Confluence`、`Gerrit`、`SVN`、`Linux`、`腾讯企业邮箱`
